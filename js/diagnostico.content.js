...
const content = {
  ...
  pasos: [
    ...
    },
    {
      ...
      opciones: [
        ...
        { label: 'Se concentra en los periodos caros o de punta de nuestra tarifa', codigo: 'punta' },
  ...
  gate: {
    ...
    cuerpo: 'Cuando gustes podemos agendar una llamada para revisar contigo las posibilidades que muestra tu diagnóstico, resolver dudas y definir qué datos de tu operación precisan el anteproyecto. Sin costo ni compromiso.',
  ...
  scoring: {
    ...
    caps: [
      ...
      // BESS + Solar necesita señal real de generación/solar; sin solar en sitio, estacionalidad o evaluación previa, se limita.
  ...
  bloqueB: {
    ...
    sinRangoPorAplicacion: {
      ...
      respaldo: 'Tu caso prioritario es la continuidad de la operación. Su valor depende de la frecuencia de los paros, las cargas críticas y el costo real de cada interrupción; no se puede derivar como porcentaje de la factura.',
      diferimiento: 'Tu caso prioritario es diferir una ampliación de capacidad. Para estimarlo necesitamos la capacidad contratada, la nueva carga y el costo y plazo de la obra evitada; no se puede derivar como porcentaje de la factura.',
  ...
  palancasCopy: {
    peak_shaving: {
      ...
      menor: 'Puede haber margen para recortar demanda, pero las demás señales de tu operación tienen más peso y conviene dimensionarlas primero.',
    ...
    solar_puro: {
      ...
      principal: 'Tu operación se concentra durante el día y tu objetivo es reducir el costo de la energía. La energía solar en sitio suele ser la inversión de retorno más rápido para tu perfil.',
    ...
    off_grid: {
      ...
      principal: 'Quieres operar sin depender de la red de CFE. Una microred de Solar + BESS (con respaldo mínimo) sostiene tu operación por sí sola. Ese es el eje de tu proyecto.',
  ...
  financiamiento: [
    ...
    { when: { sector: 'ev' }, text: 'Nuestros proyectos pueden estructurarse sin inversión inicial (PPA / Energy Storage as a Service), con el activo de nuestro lado — sujeto a evaluación de viabilidad. También puedes adquirirlo directamente si prefieres evaluarlo por retorno. Vemos cuál te conviene según tus números.' },
  ...
  recomendaciones: {
    ...
    bessCapacidad: { tipo: 'BESS para diferir capacidad', razon: 'Tu restricción para crecer o conectar nueva carga manda sobre las demás señales. La prioridad es dimensionar un BESS contra la nueva carga y la capacidad disponible de CFE; Solar solo se agrega si mejora ese caso sin retrasar la entrada en operación.' },
